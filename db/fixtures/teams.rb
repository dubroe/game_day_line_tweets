...
Team.seed(
  :abbr,
  { name: 'Anaheim Ducks', abbr: 'ANA', player_names: 'getzlaf rakell henrique kase' },
  { name: 'Arizona Coyotes', abbr: 'ARI', player_names: 'stepan kessel schmaltz dvorak'  },
  { name: 'Boston Bruins', abbr: 'BOS', player_names: 'debrusk marchand pastrnak heinen'  },
  { name: 'Buffalo Sabres', abbr: 'BUF', player_names: 'eichel reinhart skinner johansson' },
  ...
  { name: 'Chicago Blackhawks', abbr: 'CHI', player_names: 'kane toews saad strome'  },
  { name: 'Colorado Avalanche', abbr: 'COL', player_names: 'mackinnon kadri landeskog donskoi'  },
  { name: 'Columbus Blue Jackets', abbr: 'CBJ', player_names: 'dubois atkinson wennber jenner'  },
  { name: 'Dallas Stars', abbr: 'DAL', player_names: 'pavelski hintz seguin benn'  },
  { name: 'Detroit Red Wings', abbr: 'DET', player_names: 'larkin mantha nielsen athanasiou'  },
  { name: 'Edmonton Oilers', abbr: 'EDM', player_names: 'draisaitl mcdavid kassian neal'  },
  { name: 'Florida Panthers', abbr: 'FLA', player_names: 'barkov huberdeau trocheck hoffman'  },
  { name: 'Los Angeles Kings', abbr: 'LAK', player_names: 'kopitar toffoli kovalchuk iafallo'  },
  { name: 'Minnesota Wild', abbr: 'MIN', player_names: 'parise staal zucker koivu'  },
  { name: 'Montreal Canadiens', abbr: 'MTL', player_names: 'domi drouin gallagher tatar' },
  { name: 'Nashville Predators', abbr: 'NSH', player_names: 'johansen arvidsson duchene turris'  },
  { name: 'New Jersey Devils', abbr: 'NJD', player_names: 'hall coleman zajac palmieri'  },
  ...
  { name: 'Ottawa Senators', abbr: 'OTT', player_names: 'ennis duclair pageau namestnikov'  },
  { name: 'Philadelphia Flyers', abbr: 'PHI', player_names: 'giroux couturier voracek hayes'  },
  { name: 'Pittsburgh Penguins', abbr: 'PIT', player_names: 'guentzel crosby mccann kahun'  },
  { name: 'San Jose Sharks', abbr: 'SJS', player_names: 'labanc couture thornton marleau' },
  { name: 'St. Louis Blues', abbr: 'STL', player_names: 'schwartz schenn perron tarasenko'  },
  { name: 'Tampa Bay Lightning', abbr: 'TBL', player_names: 'kucherov stamkos palat killorn'  },
  { name: 'Toronto Maple Leafs', abbr: 'TOR', player_names: 'matthews nylander marner kerfoot' },
  { name: 'Vancouver Canucks', abbr: 'VAN', player_names: 'boeser pearson horvat ferland'  },
  { name: 'Vegas Golden Knights', abbr: 'VGK', player_names: 'marchessault stastny stone pacioretty'  },
